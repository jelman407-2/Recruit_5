...
pluralCaseList.push( {plural: "recruitmngs/recruits", pascal: "RecruitmngRecruit"} )

pluralCaseList.push( {plural: "hrs/hrs", pascal: "HrHr"} )

pluralCaseList.push( {plural: "departments/departments", pascal: "DepartmentDepartment"} )
